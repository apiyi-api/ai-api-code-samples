...
# Sora-2 文字生成视频完整异步流程 - Bash/Curl 版本
# 使用方法: bash sora-2-text-async.sh
...
step1_submit_request() {
    ...
    # 发送请求（使用 multipart/form-data 格式）
...
step3_download_video() {
    local video_id=$1
    local output_file="sora_text_video_${video_id##*_}.mp4"
