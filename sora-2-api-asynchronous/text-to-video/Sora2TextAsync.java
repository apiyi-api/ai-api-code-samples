 ...
 * </dependency>
 *
 * 编译: javac -cp json-20240303.jar Sora2TextAsync.java
 * 运行: java -cp .:json-20240303.jar Sora2TextAsync
 */
public class Sora2TextAsync {
    ...
    private static String step1SubmitRequest() throws Exception {
        System.out.println("============================================================");
        System.out.println("第一步：提交文字生成视频请求");
        System.out.println("============================================================");
        ...
        try (OutputStream out = conn.getOutputStream();
            ...
            // 添加表单字段（使用 multipart/form-data 格式）
    ...
    private static void step3DownloadVideo(String videoId) throws Exception {
        ...
        String outputFile = "sora_text_video_" + videoId.substring(Math.max(0, videoId.length() - 8)) + ".mp4";
